...
type TranslationContent = {
  ...
  masterTradingTitle: string
  masterTradingHighlight: string
  ctaParagraph1: string
  ctaParagraph2: string
  ctaParagraph3: string
  ctaParagraph4: string
  startNowButton: string
  advantagesTitle: string
  advantagesIntro: string
  growthPotentialTitle: string
  growthPotentialText: string
  diversificationTitle: string
  diversificationText: string
  focusOnPlatformTitle: string
  focusOnPlatformText1: string
  focusOnPlatformText2: string
  focusOnPlatformText3: string
  focusOnPlatformText4: string
  nineReasonsIntro: string
  reason1: string
  reason2: string
  reason3: string
  reason4: string
  ...
  feature2: string
  feature3: string
  platformUnnoticedText: string
  investSmartTitle: string
  investSmartText1: string
  investSmartText2: string
  algorithmToolsIntro: string
  tool1: string
  tool2: string
  tool3: string
  tool4: string
  finalInvitation: string
  potentialEarningsTitle: string
  myInvestment: string
  usagePeriod: string
  days: string
  potentialProfit: string
  startInvestingNowButton: string
  disclaimer: string
  ...
  tradingEasyTitle: string
  tradingEasyHighlight: string
  tradingEasyIntro: string
  featureAiSelectionsTitle: string
  featureAiSelectionsText: string
  featureAutoTradingTitle: string
  featureAutoTradingText: string
  ...
  finalSectionSubtitle: string
  finalSectionText: string
  footerCompanyInfo: string
  footerContactanos: string
  footerPrivacidad: string
  footerTerminos: string
  footerDescargo: string
  footerEmailLabel: string
  footerCopyright: string
  officialRegistrationNumber: string
  smallFormNamePlaceholder: string
  smallFormSurnamePlaceholder: string
  smallFormEmailPlaceholder: string
  smallFormPhonePlaceholder: string
  smallFormDobPlaceholder: string
  smallFormRegisterButton: string
  smallFormTermsText: string
  smallFormPrivacyText: string
...
const translations: Record<Language, TranslationContent> = {
  es: {
    notification: "¡Actúa ahora! Coin Sin Limited está acelerando las ganancias de los participantes! ¡Asegura tu lugar antes de que caduqe la invitación Privada!",
    ...
    motivationalText: "TIENES DERECHO A LA INDEPENDENCIA FINANCIERA, Y NO ES UN PRIVILEGIO. ES TU DERECHO, INDEPENDIENTEMENTE DE TU EDAD, LOGROS Y ESTATUS SOCIAL.",
    ...
    termsText: "Al registrarte, aceptas y estás de acuerdo con los términos de uso y la Política de privacidad del sitio.",
    privacyText: "Tus datos siempre están protegidos con Coin Sin Limited. Al completar este formulario, aceptas recibir nuestros correos electrónicos de marketing.", // Modified
    ...
    ctaParagraph1: "Imagina una nueva vida en la que el trabajo se vuelva opcional, los ahorros ya no sean necesarios y todas tus facturas se paguen sin esfuerzo. Imagina la libertad de explorar, planificar un coche nuevo o incluso tener una casa.",
    ctaParagraph2: "Ahora imagínate mirando la pantalla de tu teléfono inteligente y siendo testigo de otra ganancia de 1,000€ sin esfuerzo hoy mismo. Suena atractivo, ¿verdad?",
    ...
    ctaParagraph4: "¿Listo para unirte a nosotros? ¡Sigue las instrucciones de esta página y emprende tu emocionante viaje hacia una vida estable y sin preocupaciones, llena de abundantes placeres!",
    startNowButton: "Empieza ahora",
    advantagesTitle: "VENTAJAS DE INVERTIR EN DIVISAS POPULARES E INFORMACIÓN ESENCIAL SOBRE LA PLATAFORMA COIN SIN LIMITED",
    advantagesIntro: "Invertir en divises digitales es una opción atractiva para los inversores. Las criptomonedas reúnen todas las características necesarias para ofrecer una liquidez estable. Dos factores clave determinan los beneficios de esta tipo de inversiones:",
    growthPotentialTitle: "Potencial de crecimiento:",
    growthPotentialText: "Algunas criptomonedas ya han alcanzado un valor significativo, pero muchos proyectos tienen un gran potencial de desarrollo. Debido a su creciente popularidad, el mercado de las criptomonedas atrae a inversores que pueden obtener altos rendimientos invirtiendo en activos digitales.",
    diversificationTitle: "Diversificación de la cartera:",
    diversificationText: "Las criptomonedas brindan la oportunidad de diversificar su cartera de inversiones. Proporcionan una clase de activos alternativa que es independiente de los mercados financieros tradicionales. Invertir en criptomonedas ayuda a diversificar el riesgo y a proteger la cartera de posibles influencias negativas en un área.",
    focusOnPlatformTitle: "Centrémonos ahora en la plataforma Coin Sin Limited.",
    focusOnPlatformText1: "¿Por qué la inteligencia artificial (IA) es fundamental para el mercado de inversión? La IA es más rápida que el cerebro humano y puede analizar datos con precisión, siempre que el sistema esté configurado correctamente. El aprendizaje automático tiene tres ventajas significativas en el mercado de inversión.",
    focusOnPlatformText2: "Además, la inteligencia artificial opera en el mercado las 24/7 ahora. Significa conocimiento de la situación global en tiempo real, acumulación de conocimientos sobre patrones y creación inmediata de estrategias rentables. La plataforma Coin Sin Limited ofrece una rentabilidad eficaz de alcanzar para los humanos. Es cuestión de tiempo que las máquinas asuman plenamente esta función.",
    focusOnPlatformText3: "Otro factor que hace atractiva la inversión en Canadá, Australia y otros países es la educación. Muchas personas sienten que un humano puede tomar decisiones influido por las emociones, una máquina permanece objetiva y racional. Es fundamental no olvidar las emociones. Separar la racionalidad de la emoción es crucial, especialmente en la esfera de la inversión, donde todo se decide basándose en datos puros y previsiones exactas.",
    focusOnPlatformText4: "Además, invertir antes de obtener ingresos es significativamente diferente. Antes de que una persona empiece a obtener ingresos, gasta una cantidad significativa de dinero en pruebas, lo que tiene beneficios, además de adquirir experiencia situacional y conciencia de la inversión. En cambio, una máquina se encarga de esto mucho más rápido y requiere un desembolso mínimo para maximizar los ingresos.",
    nineReasonsIntro: "Así pues, tenemos nueve razones principales por las que utilizar la plataforma Coin Sin Limited es beneficioso, especialmente para los operadores principiantes:",
    reason1: "Nuestras herramientas de trading procesan grandes cantidades de datos de forma rápida y eficiente, lo que le permite tomar decisiones precisas.",
    reason2: "El software basado en inteligencia artificial proporciona un análisis avanzado del mercado con datos y previsiones precisas.",
    reason3: "La inteligencia artificial se adapta a las condiciones actuales del mercado, sugiriendo las mejores estrategias de inversión.",
    reason4: "Invertir con un sistema basado en inteligencia artificial no se ve afectado por errores humanos y proporciona información objetiva.",
    reason5: "Invertir usando una máquina es más barato que tomar decisiones humanas y genera más beneficios.",
    reason6: "La inteligencia artificial requiere menos inversión inicial, lo que aumenta la eficiencia de la inversión.",
    reason7: "Invertir con herramientas basadas en inteligencia artificial hace que las inversiones sean asimilables en Canadá, Australia y otros países.",
    reason8: "El uso de la inteligencia artificial aumenta la velocidad de la toma de decisiones.",
    reason9: "La inteligencia artificial proporciona una toma de decisiones más rápida para realizar mejores acciones de inversión.",
    efficiencyGuarantee: "Así, la inteligencia artificial garantiza la rentabilidad de la inversión al asegurar una eficacia de los sistemas de al menos el 95%. La precisión depende del sistema específico, pero puede alcanzar para los humanos entre el 95% y el 99,4%. La eficiencia de nuestros instrumentos de negociación basados en algoritmos Coin Sin Limited es del 99,4%.",
    platformBenefitTitle: "COIN SIN LIMITED ES UNA PLATAFORMA QUE TRABAJA EN BENEFICIO DEL INVERSOR",
    platformBenefitText1: "Para los inversores novatos, invertir en criptomonedas puede resultar increíblemente complicado. A menudo, los principiantes necesitan comprender todos los entresijos de este ámbito para no perder sus pequeñas inversiones en el menor tiempo posible. Esto les lleva a perder el interés por las criptomonedas y por la inversión en general. Sin embargo, necesitan darse cuenta de las oportunidades potenciales que están perdiendo.",
    platformBenefitText2: "La plataforma Coin Sin Limited les permite hacer realidad sus sueños de ingresos pasivos estables. Basado en inteligencia artificial, este algoritmo trabaja continuamente, analizando la situación del mercado, estudiando las tendencias de las criptomonedas y realizando operaciones que casi siempre resultan rentables. Miles de personas en todo el mundo ya han generado miles de millones de euros con Coin Sin Limited.",
    platformFeaturesTitle: "Las características de la plataforma Coin Sin Limited incluyen:",
    feature1: "Un profundo conocimiento del mercado de criptomonedas y de las tendencias en el mundo de los activos digitales que están fuera del alcance de la mente humana.",
    feature2: "El superordenador puede calcular millones de variaciones cada segundo y predecir tendencias con la máxima precisión.",
    feature3: "Operaciones seguras con beneficios para el inversor.",
    platformUnnoticedText: "La plataforma Coin Sin Limited pasó desapercibida en el momento del lanzamiento del producto. Sin embargo, está provocando la ira y el pánico de bancos centrales y gobiernos de todo el mundo. Mientras los grandes jugadores intentan detener el proyecto de la plataforma Coin Sin Limited, usted puede empezar a ganar mucho dinero ahora.",
    investSmartTitle: "INVIERTE EN CRIPTODIVISAS DE FORMA INTELIGENTE CON LA PLATAFORMA COIN SIN LIMITED",
    investSmartText1: "Los tiempos no son fáciles, y todo a nuestro alrededor va poco a poco hacia abajo. Aunque la situación puede mejorar en el futuro, todo el mundo debería ocuparse hoy de su futuro para no depender de factores externos. Las herramientas inteligentes pueden ayudarte con esto.",
    investSmartText2: "La plataforma de inversión Coin Sin Limited le permite hacerlo sin perder tiempo estudiando el mercado de divisas digitales. Puede empezar a invertir hoy mismo en países como Canadá, Australia y otros. El éxito está precalculado, y todo lo que necesita es el deseo de unirse.",
    ...
    finalInvitation: "¡Por lo tanto, le invitamos a empezar a escribir la primera página de su historia de un inversor de éxito hoy después de leer la revisión de Coin Sin Limited!",
    ...
    disclaimer: "* Los resultados mostrados son estimaciones basadas en el rendimiento histórico de la plataforma. Las inversiones conllevan riesgos.",
    demoAccountTitle: "PRUEBE LA CUENTA DE DEMOSTRACIÓN DE COIN SIN LIMITED",
    notScamText2: "Los usuarios tienen acceso a una cuenta de demostración virtual donde pueden evaluar las capacidades del sistema sin riesgo antes de invertir fondos reales. La protección del usuario es el requisito principal del proyecto. SSL certificates y el cifrado multicapa protegen de manera fiable todos los datos personales.",
    notScamTitle: "COIN SIN LIMITED NO ES UNA ESTAFA, Y ESTA ES LA RAZÓN",
    notScamText1: "Es un proyecto de inversión automatizado que ofrece la oportunidad de ganar dinero invirtiendo en criptomonedas populares y prometedores proyectos en el mundo de los activos digitales. El sistema está controlado por ingenieros informáticos y corredores registrados en CySEC. Los corredores autorizados llevan a cabo los procesos financieros en el sistema.",
    notScamText3: "Por seguridad, se recomienda cerrar la sesión después de cada uso y evitar conectarse al sistema desde redes públicas.",
    notScamText4: "Coin Sin Limited ofrece máximos beneficios y ganancias sin riesgo, y presenta pruebas de no fraude. También encontrará opiniones sobre Coin Sin Limited a continuación.",
    ...
    tradingEasyIntro: "Al enviar el formulario a continuación con su información precisa en este sitio web, desbloqueará rápidamente el acceso ilimitado a nuestro sistema de trading de IA altamente confiable, dedicado e imparcial. Únase a los más de 2,500 inversores astutos que ya se están beneficiando de sus capacidades.",
    ...
    featureAutoTradingText: "Experimenta la conveniencia de nuestra función de trading automático, que te permite generar ganancias sin esfuerzo, incluso cuando no estés en tu puesto de trabajo. ¡No se requiere experiencia comercial! Simplemente haz tu inversión inicial y observa cómo el saldo de tu cuenta crece constantemente.",
    featureSupportTitle: "SOPORTE INTEGRAL AL USUARIO",
    featureSupportText: "Como miembro valioso de Coin Sin Limited, nuestro amable gestor de atención al cliente está a tu disposición, listo para resolver cualquier pregunta o preocupación que puedas tener.",
    featureCommunityTitle: "ACCESO EXCLUSIVO A UNA COMUNIDAD ÚNICA",
    featureCommunityText: "Únete a nuestra prestigiosa comunidad Coin Sin Limited y obtén una membresía privilegiada. Considérate afortunado de haber encontrado la oportunidad de registrarte. Ten en cuenta que, debido a las limitaciones de capacidad del sistema, solo podemos enviar invitaciones a un número selecto de usuarios. Aprovecha esta oportunidad para resolver tus problemas financieros de una vez por todas.",
    ...
    step1Description: "El formulario de registro está en esta página. Completa el formulario para convertirte en miembro. Una vez que tu registro sea aprobado, automáticamente te convertirás en un nuevo participante de Coin Sin Limited.",
    step2Title: "DEPOSITA €250 O MÁS",
    step2Description: "Como en cualquier negocio, necesitas capital inicial. La ventaja de la plataforma Coin Sin Limited es que solo requiere una inversión inicial modest. Simplemente deposita 250€ o más para empezar a ganar dinero.",
    step3Title: "ESTATE ATENTO A TU TELÉFONO... ¡PODRÍAS RECIBIR UNA LLAMADA!",
    step3Description: "Después de hacer un pago, nuestro gestor se pondrá en contacto contigo para confirmar todo y activar tu cuenta. Si tienes alguna pregunta, el gestor te proporcionará respuestas detalladas para ayudarte. Ten en cuenta que la llamada puede provenir de un número no identificado.",
    faqTitle: "PREGUNTAS",
    ...
    finalSectionText: "Actúa ahora proporcionando tu nombre completo y correo electrónico en el formulario a continuación, y desbloquea la oportunidad más excepcional y exclusiva para generar ingresos sustanciales sin esfuerzo. Deja que la IA se encargue del trabajo duro mientras tú obtienes beneficios tangibles al instante. ¡No te lo pierdas!",
    footerCompanyInfo: "Coin Sin Limited es una empresa especializada en proporcionar información y herramientas para la inversión y el comercio de criptomonedas, basadas en inteligencia artificial.",
    ...
    smallFormTermsText: "Al registrarte, aceptas y estás de acuerdo con los términos de uso y la Política de privacidad del sitio.",
    smallFormPrivacyText: "Tus datos siempre están protegidos con Coin Sin Limited. Al completar este formulario, aceptas recibir nuestros correos electrónicos de marketing.", // Modified
  ...
  en: {
    notification: "Act now! Coin Sin Limited is accelerating participants' earnings! Secure your spot before the private invitation expires!",
    ...
    motivationalText: "YOU HAVE THE RIGHT TO FINANCIAL INDEPENDENCE, AND IT IS NOT A PRIVILEGE. IT IS YOUR RIGHT, REGARDLESS OF YOUR AGE, ACHIEVEMENTS, AND SOCIAL STATUS.",
    ...
    privacyText: "Your data is always protected with Coin Sin Limited. By completing this form, you agree to receive our marketing emails.", // Modified
    ...
    ctaParagraph1: "Imagine a new life where work becomes optional, savings are no longer necessary, and all your bills are paid effortlessly. Imagine the freedom to explore, plan a new car, or even own a home.",
    ctaParagraph2: "Now imagine looking at your smartphone screen and witnessing another effortless €1,000 gain today. Sounds appealing, right?",
    ctaParagraph3: "Coin Sin Limited makes it possible. As an AI-powered startup platform, we empower new investors to dive into the world of cryptocurrency investments, regardless of their prior experience. By starting with an investment of just €250, you can seize the opportunity to multiply your daily earnings by x5.",
    ctaParagraph4: "Ready to join us? Follow the instructions on this page and embark on your exciting journey to a stable, worry-free life, full of abundant pleasures!",
    startNowButton: "Start Now",
    advantagesTitle: "ADVANTAGES OF INVESTING IN POPULAR CURRENCIES AND ESSENTIAL INFORMATION ABOUT THE COIN SIN LIMITED PLATFORM",
    advantagesIntro: "Investing in digital currencies is an attractive option for investors. Cryptocurrencies bring together all the necessary characteristics to offer stable liquidity. Two key factors determine the benefits of this type of investment:",
    growthPotentialTitle: "Growth Potential:",
    growthPotentialText: "Some cryptocurrencies have already reached significant value, but many projects have great development potential. Due to their growing popularity, the cryptocurrency market attracts investors who can obtain high returns by investing in digital assets.",
    diversificationTitle: "Portfolio Diversification:",
    diversificationText: "Cryptocurrencies provide an opportunity to diversify your investment portfolio. They provide an alternative asset class that is independent of traditional financial markets. Investing in cryptocurrencies helps diversify risk and protect the portfolio from potential negative influences in one area.",
    focusOnPlatformTitle: "Let's now focus on the Coin Sin Limited platform.",
    focusOnPlatformText1: "Why is artificial intelligence (AI) fundamental to the investment market? AI is faster than the human brain and can analyze data accurately, provided the system is configured correctly. Machine learning has three significant advantages in the investment market.",
    focusOnPlatformText2: "Furthermore, artificial intelligence operates in the market 24/7 now. It means real-time global situation awareness, knowledge accumulation about patterns, and immediate creation of profitable strategies. The Coin Sin Limited platform offers an effective profitability achievable by humans. It is a matter of time until machines fully assume this function.",
    focusOnPlatformText3: "Another factor that makes investing in Canada, Australia, and other countries attractive is education. Many people feel that a human can take decisions influenced by emotions, a machine remains objective and rational. It is essential not to forget emotions. Segregating rationality from emotion is fundamental, but a realization in the investment sphere, where everything is decided based on pure data and exact forecasts.",
    focusOnPlatformText4: "Additionally, investing before earning income is significantly different. Before a person starts earning income, they spend a significant amount of money on testing, which has benefits, in addition to gaining situational experience and investment awareness. In contrast, a machine handles this much faster and requires minimal outlay to maximize income.",
    nineReasonsIntro: "So, we have nine main reasons why using the Coin Sin Limited platform is beneficial, especially for beginner traders:",
    reason1: "Our trading tools process large amounts of data quickly and efficiently, allowing you to take accurate decisions.",
    ...
    efficiencyGuarantee: "Thus, artificial intelligence guarantees investment profitability by ensuring system effectiveness of at least 95%. Accuracy depends on the specific system, but can reach between 95% and 99.4% for humans. The efficiency of our Coin Sin Limited algorithm-based trading instruments is 99.4%.",
    platformBenefitTitle: "COIN SIN LIMITED IS A PLATFORM THAT WORKS FOR THE INVESTOR'S BENEFIT",
    platformBenefitText1: "For novice investors, investing in cryptocurrencies can be incredibly complicated. Often, beginners need to understand all the ins and outs of this field so as not to lose their small investments in the shortest possible time. This leads to them losing interest in cryptocurrencies and in investing in general. However, they need to realize the potential opportunities they are missing.",
    platformBenefitText2: "The Coin Sin Limited platform allows them to make their dreams of stable passive income come true. Based on artificial intelligence, this algorithm works continuously, analyzing the market situation, studying cryptocurrency trends, and performing operations that almost always result in profits. Thousands of people around the world have already generated billions of euros with Coin Sin Limited.",
    platformFeaturesTitle: "The features of the Coin Sin Limited platform include:",
    feature1: "A deep understanding of the cryptocurrency market and trends in the world of digital assets that are beyond the reach of the human mind.",
    feature2: "The supercomputer can calculate millions of variants every second and predict trends with maximum accuracy.",
    feature3: "Secure operations with benefits for the investor.",
    platformUnnoticedText: "The Coin Sin Limited platform went unnoticed at the time of product launch. However, it is causing anger and panic among central banks and governments around the world. While big players try to stop the Coin Sin Limited platform project, you can start earning big money now.",
    investSmartTitle: "INVEST IN CRIPTOCURRENCIES SMARTLY WITH THE COIN SIN LIMITED PLATFORM",
    investSmartText1: "Times are not easy, and everything around us is slowly going down. Although the situation may improve in the future, everyone should take care of their future today so as not to depend on external factors. Smart tools can help you with this.",
    investSmartText2: "The Coin Sin Limited investment platform allows you to do so without wasting time studying the digital currency market. You can start investing today in countries like Canada, Australia, and others. Success is pre-calculated, and all you need is the desire to join.",
    ...
    finalInvitation: "Therefore, we invite you to start writing the first page of your success story as an investor today after reading the Coin Sin Limited review!",
    ...
    disclaimer: "* The results shown are estimates based on the platform's historical performance. Investments carry risks.",
    demoAccountTitle: "TRY THE COIN SIN LIMITED DEMO ACCOUNT",
    notScamText2: "Users have access to a virtual demo account where they can risk-free evaluate the system's capabilities before investing real funds. User protection is the main requirement of the project. SSL certificates and multi-layer encryption reliably protect all personal data.",
    notScamTitle: "COIN SIN LIMITED IS NOT A SCAM, AND HERE'S WHY",
    notScamText1: "It is an automated investment project that offers the opportunity to earn money by investing in popular cryptocurrencies and promising projects in the world of digital assets. The system is controlled by computer engineers and brokers registered with CySEC. Authorized brokers carry out the financial processes in the system.",
    notScamText3: "For security, it is recommended to log out after each use and avoid connecting to the system from public networks.",
    notScamText4: "Coin Sin Limited offers maximum benefits and risk-free earnings, and presents proof of non-fraud. You will also find opinions about Coin Sin Limited below.",
    ...
    tradingEasyIntro: "By submitting the form below with your accurate information on this website, you will quickly unlock unrestricted access to our highly reliable, dedicated, and unbiased AI trading system. Join the more than 2,500 astute investors who are already benefiting from its capabilities.",
    ...
    featureAutoTradingText: "Experience the convenience of our automatic trading feature, which allows you to effortlessly generate profits, even when you are not at your workstation. No trading experience required! Simply make your initial investment and watch your account balance grow steadily.",
    featureSupportTitle: "COMPREHENSIVE USER SUPPORT",
    featureSupportText: "As a valuable member of Coin Sin Limited, our friendly customer service manager is at your disposal, ready to address any questions or concerns you may have.",
    featureCommunityTitle: "EXCLUSIVE ACCESS TO A UNIQUE COMMUNITY",
    featureCommunityText: "Join our prestigious Coin Sin Limited community and gain privileged membership. Please note that, due to system capacity limitations, we can only send invitations to a select number of users. Take advantage of this opportunity to solve your financial problems once and for all.",
    ...
    step1Description: "The registration form is on this page. Complete the form to become a member. Once your registration is approved, you will automatically become a new Coin Sin Limited participant.",
    step2Title: "DEPOSIT €250 OR MORE",
    step2Description: "As in any business, you need initial capital. The advantage of the Coin Sin Limited platform is that it only requires a modest initial investment. Simply deposit €250 or more to start earning money.",
    step3Title: "STAY TUNED TO YOUR PHONE... YOU MIGHT RECEIVE A CALL!",
    step3Description: "After making a payment, our manager will contact you to confirm everything and activate your account. If you have any questions, the manager will provide detailed answers to help you. Please note that the call may come from an unidentified number.",
    faqTitle: "FREQUENTLY",
    ...
    finalSectionText: "Take action now by providing your full name and email in the form below, and unlock the most exceptional and exclusive opportunity to generate substantial income effortlessly. Let AI handle the hard work while you reap tangible benefits instantly. Don't miss out!",
    footerCompanyInfo: "Coin Sin Limited is a company specializing in providing information and tools for cryptocurrency investment and trading, based on artificial intelligence.",
    ...
    smallFormPrivacyText: "Your data is always protected with Coin Sin Limited. By completing this form, you agree to receive our marketing emails.", // Modified
  ...
  ca: {
    ...
    notification: "Actua ara! Coin Sin Limited està accelerant els guanys dels participants! Assegura el teu lloc abans que caduqui la invitació Privada!",
    ...
    motivationalText: "TENS DRET A LA INDEPENDÈNCIA FINANCERA, I NO ÉS UN PRIVILEGI. ÉS EL TU DRET, INDEPENDENTMENT DE LA TEVA EDAT, ASSOLIMENTS I ESTATUS SOCIAL.",
    ...
    privacyText: "Les teves dades sempre estan protegides amb Coin Sin Limited. En completar aquest formulari, acceptes rebre els nostres correus electrònics de màrqueting.", // Modified
    ...
    ctaParagraph1: "Imagina una nova vida en la qual la feina esdevingui opcional, els estalvis ja no siguin necessaris i totes les teves factures es paguin sense esforç. Imagina la llibertat d'explorar, planificar un cotxe nou o fins i tot tenir una casa.",
    ctaParagraph2: "Ara imagina't mirant la pantalla del teu telèfon intel·ligent i sent testimoni d'un altre guany de 1.000€ sense esforç avui mateix. Sona atractiu, oi?",
    ...
    ctaParagraph4: "Llest per unir-te a nosaltres? Segueix les instruccions d'aquesta pàgina i emprèn el teu emocionant viatge cap a una vida estable i sense preocupacions, plena d'abundants plaers!",
    startNowButton: "Comença ara",
    advantagesTitle: "AVANTATGES D'INVERTIR EN DIVISES POPULARS I INFORMACIÓ ESSENCIAL SOBRE LA PLATAFORMA COIN SIN LIMITED",
    advantagesIntro: "Invertir en divises digitals és una opció atractiva per als inversors. Les criptomonedes reuneixen totes les característiques necessàries per oferir una liquiditat estable. Dos factors clau determinen els beneficis d'aquest tipus d'inversions:",
    growthPotentialTitle: "Potencial de creixement:",
    growthPotentialText: "Algunes criptomonedes ja han assolit un valor significatiu, però molts projectes tenen un gran potencial de desenvolupament. A causa de la seva creixent popularitat, el mercat de les criptomonedes atrau inversors que poden obtenir alts rendiments invertint en actius digitals.",
    diversificationTitle: "Diversificació de la cartera:",
    diversificationText: "Les criptomonedes brinden l'oportunitat de diversificar la seva cartera de inversions. Proporcionen una classe d'actius alternativa que és independent dels mercats financers tradicionals. Invertir en criptomonedes ajuda a diversificar el risc i a protegir la cartera de possibles influències negatives en una àrea.",
    focusOnPlatformTitle: "Centrem-nos ara en la plataforma Coin Sin Limited.",
    focusOnPlatformText1: "Per què la intel·ligència artificial (IA) és fonamental per al mercat d'inversió? La IA és més ràpida que el cervell humà i pot analitzar dades amb precisió, sempre que el sistema estigui configurat correctament. L'aprenentatge automàtic té tres avantatges significatius en el mercat d'inversió.",
    focusOnPlatformText2: "A més, la intel·ligència artificial opera en el mercat les 24/7 ara. Significa coneixement de la situació global en temps real, acumulació de coneixements sobre patrons i creació immediata d'estratègies rentables. La plataforma Coin Sin Limited ofereix una rendibilitat eficaç d'assolir per als humans. És qüestió de temps que les màquines assumeixin plenament aquesta funció.",
    focusOnPlatformText3: "Un altre factor que fa atractiva la inversió al Canadà, Austràlia i altres països és l'educació. Moltes persones senten que un humà pot prendre decisions influït per les emocions, una màquina roman objectiva i racional. És fonamental no oblidar les emocions. Segregar la racionalitat de l'emoció és fonamental, però una realitat en l'esfera de la inversió, on tot es decideix basant-se en dades pures i previsions exactes.",
    focusOnPlatformText4: "A més, invertir abans d'obtenir ingressos és significativament diferent. Abans que una persona comenci a obtenir ingressos, gasta una quantitat significativa de diners en proves, la qual cosa té beneficis, a més d'adquirir experiència situacional i consciència de la inversió. En canvi, una màquina s'encarrega d'això molt més ràpid i requereix un desemborsament mínim per maximitzar els ingressos.",
    nineReasonsIntro: "Així doncs, tenim nou raons principals per les quals utilitzar la plataforma Coin Sin Limited és beneficiós, especialment per als operadors principiants:",
    reason1: "Les nostres eines de trading processen grans quantitats de dades de forma ràpida i eficient, la qual cosa li permet prendre decisions precises.",
    reason2: "El programari basat en intel·ligència artificial proporciona una anàlisi avançada del mercat amb dades i previsions precises.",
    reason3: "La intel·ligència artificial s'adapta a les condicions actuals del mercat, suggerint les millors estratègies d'inversió.",
    reason4: "Invertir amb un sistema basat en intel·ligència artificial no es veu afectat per errors humans i proporciona informació objectiva.",
    reason5: "Invertir usant una màquina és més barat que prendre decisions humanes i genera més beneficis.",
    reason6: "La intel·ligència artificial requereix menys inversió inicial, la qual cosa augmenta l'eficiència de la inversió.",
    reason7: "Invertir amb eines basades en intel·ligència artificial fa que les inversions siguin assequibles al Canadà, Austràlia i altres països.",
    reason8: "L'ús de la intel·ligència artificial augmenta la velocitat de la presa de decisions.",
    reason9: "La intel·ligència artificial proporciona una presa de decisions més ràpida per realitzar millors accions d'inversió.",
    efficiencyGuarantee: "Així, la intel·ligència artificial garanteix la rendibilitat de la inversió en assegurar una eficàcia dels sistemes d'almenys el 95%. La precisió depèn del sistema específic, però pot assolir per als humans entre el 95% i el 99,4%. L'eficiència dels nostres instruments de negociació basats en algoritmes Coin Sin Limited és del 99,4%.",
    platformBenefitTitle: "COIN SIN LIMITED ÉS UNA PLATAFORMA QUE TREBALLA EN BENEFICI DE L'INVERSOR",
    platformBenefitText1: "Per als inversors novells, invertir en criptomonedes pot resultar increïblement complicat. Sovint, els principiants necessiten comprendre tots els secrets d'aquest àmbit per no perdre les seves petites inversions en el menor temps possible. Això els porta a perdre l'interès per les criptomonedes i per la inversió en general. No obstant això, necessiten adonar-se de les oportunitats potencials que estan perdent.",
    platformBenefitText2: "La plataforma Coin Sin Limited els permet fer realitat els seus somnis d'ingressos passius estables. Basat en intel·ligència artificial, aquest algoritme treballa contínuament, analitzant la situació del mercat, estudiant les tendències de les criptomonedes i realitzant operacions que gairebé sempre resulten rentables. Milers de persones a tot el món ja han generat milers de milions d'euros amb Coin Sin Limited.",
    platformFeaturesTitle: "Les característiques de la plataforma Coin Sin Limited inclouen:",
    feature1: "Un profund coneixement del mercat de criptomonedes i de les tendències en el món dels actius digitals que estan fora de l'abast de la ment humana.",
    feature2: "El superordinador pot calcular milions de variacions cada segon i predir tendències amb la màxima precisió.",
    feature3: "Operacions segures amb beneficis per a l'inversor.",
    platformUnnoticedText: "La plataforma Coin Sin Limited va passar desapercebuda en el moment del llançament del producte. No obstant això, està provocant la ira i el pànic de bancs centrals i governs de tot el món. Mentre els grans jugadors intenten aturar el projecte de la plataforma Coin Sin Limited, vostè pot començar a guanyar molts diners ara.",
    investSmartTitle: "INVERTEIX EN CRIPTODIVISES DE FORMA INTEL·LIGENT AMB LA PLATAFORMA COIN SIN LIMITED",
    investSmartText1: "Els temps no són fàcils, i tot al nostre voltant va a poc a poc cap avall. Encara que la situació pot millorar en el futur, tothom hauria d'ocupar-se avui del seu futur per no dependre de factors externs. Les eines intel·ligents poden ajudar-te amb això.",
    investSmartText2: "La plataforma d'inversió Coin Sin Limited le permet fer-ho sense perdre temps estudiant el mercat de divises digitals. Pot començar a invertir avui mateix en països com el Canadà, Austràlia i altres. L'èxit està precalculat, i tot el que necessita és el desig d'unir-se.",
    ...
    finalInvitation: "Per tant, el convidem a començar a escriure la primera pàgina de la seva història d'un inversor d'èxit avui després de llegir la revisió de Coin Sin Limited!",
    ...
    disclaimer: "* Els resultats mostrats són estimacions basades en el rendiment històric de la plataforma. Les inversions comporten riscos.",
    demoAccountTitle: "PROVA EL COMPTE DE DEMOSTRACIÓ DE COIN SIN LIMITED",
    notScamText2: "Els usuaris tenen accés a un compte de demostració virtual on poden avaluar les capacitats del sistema sense risc abans d'invertir fons reals. La protecció de l'usuari és el requisit principal del projecte. SSL certificates i el xifratge multicapa protegeixen de manera fiable totes les dades personals.",
    notScamTitle: "COIN SIN LIMITED NO ÉS UNA ESTAFA, I AQUESTA ÉS LA RAÓ",
    notScamText1: "És un projecte d'inversió automatitzat que ofereix l'oportunitat de guanyar diners invertint en criptomonedes populars i projectes prometedors en el món dels actius digitals. El sistema està controlat per enginyers informàtics i corredors registrats a CySEC. Els corredors autoritzats realitzen els processos financers del sistema.",
    notScamText3: "Per seguretat, es recomana tancar la sessió després de cada ús i evitar connectar-se al sistema des de xarxes públiques.",
    notScamText4: "Coin Sin Limited ofereix màxims beneficis i guanys sense risc, i presenta proves de no fraud. També trobaràs opinions sobre Coin Sin Limited a continuació.",
    ...
    tradingEasyHighlight: "100% FÀCIL I CÓMODE!",
    tradingEasyIntro: "En enviar el formulari següent amb la teva informació precisa en aquest lloc web, desbloquejaràs ràpidament l'accés il·limitat al nostre sistema de trading d'IA altament fiable, dedicat i imparcial. Uneix-te als més de 2.500 inversors astuts que ja s'estan beneficiant de les seves capacitats.",
    featureAiSelectionsTitle: "SELECCIONS D'INVERSIÓ EXCLUSIVAMENT RENDIBLES REALITZADES PER IA",
    featureAiSelectionsText: "Enrere van quedar els dies en què les inversions estaven reservades per als rics. El nostre avançat sistema informàtic analitza meticulosament la liquiditat, la volatilitat i el volum d'operacions, la qual cosa garanteix decisions d'inversió òptimes. Gaudeix d'ingressos constants al teu compte a través d'accions d'empreses de primer nivell, recolzades per una impressió garantia de precisió comercial del 99.4%.",
    featureAutoTradingTitle: "FUNCIONALITAT DE COMERÇ AUTOMÀTIC IMPECABLE",
    featureAutoTradingText: "Experimenta la comoditat de la nostra funció de trading automàtic, que et permet generar guanys sense esforç, fins i tot quan no estiguis al teu lloc de treball. No es requereix experiència comercial! Simplement fes la teva inversió inicial i observa com el saldo del teu compte creix constantment.",
    featureSupportTitle: "SUPORT INTEGRAL A L'USUARI",
    featureSupportText: "Com a membre valuós de Coin Sin Limited, el nostre amable gestor d'atenció al client està a la teva disposició, preparat per resoldre qualsevol pregunta o preocupació que puguis tenir.",
    featureCommunityTitle: "ACCÉS EXCLUSIU A UNA COMUNITAT ÚNICA",
    featureCommunityText: "Uneix-te a la nostra prestigiosa comunitat Coin Sin Limited i obtén una membresia privilegiada. Considera't afortunat d'haver trobat l'oportunitat de registrar-te. Tingues en compte que, a causa de les limitacions de capacitat del sistema, només podem enviar invitacions a un número selecte de usuaris. Aprofita aquesta oportunitat per resoldre els teus problemes financers d'una vegada per totes.",
    ...
    step1Description: "El formulari de registre està en aquesta pàgina. Completa el formulari per convertir-te en membre. Una vegada que el teu registre sigui aprovat, automàticament et convertiràs en un nou participant de Coin Sin Limited.",
    step2Title: "DEPOSITA €250 O MÉS",
    step2Description: "Com a qualsevol negoci, necessites capital inicial. L'avantatge de la plataforma Coin Sin Limited és que només requereix una inversió inicial modesta. Simplement diposita 250€ o més per començar a guanyar diners.",
    step3Title: "RESTA SINTONITZAT SUL TU TELÈFON... POTRIES REBRE UNA TRUCADA!",
    step3Description: "Després de fer un pagament, el nostre gestor es posarà en contacte amb tu per confirmar-ho tot i activar el teu compte. Si tens alguna pregunta, el gestor et proporcionarà respostes detallades per ajudar-te. Tenere presente que la trucada podria provenir d'un número no identificat.",
    faqTitle: "PREGUNTES",
    faqHighlight: "FREQUENTS",
    finalSectionTitle: "COGLI L'OPPORTUNITÀ DI DIVENTARE UN INVESTITORE INTEL·LIGENT OGGI E...",
    finalSectionSubtitle: "...SCATENA UN MÓN DE POSSIBILITÀ, CON UN MÍNIMO DE 1.000€ SUL TUO CONTO OGNI GIORNO!",
    finalSectionText: "Agisci ora fornendo il tuo nome completo e la tua email nel modulo sottostante, e sblocca l'opportunità più eccezionale ed exclusiva per generare un reddito sostanziale senza sforzo. Lascia che l'IA si ocupi del lavoro duro mientras tú recoges beneficios tangibili al instante. ¡No te lo pierdas!",
    footerCompanyInfo: "Coin Sin Limited és una empresa especialitzada en proporcionar informació i eines per a la inversió i el comerç de criptomonedes, basades en intel·ligència artificial.",
    ...
    smallFormPhonePlaceholder: "9 11 2345-6789",
    smallFormDobPlaceholder: "Data di Naixement",
    smallFormRegisterButton: "Registrami",
    smallFormTermsText: "Registrandoti, accetti e sei d'accordo con i termini d'uso e la Politica sulla privacy del sito.",
    smallFormPrivacyText: "I tuoi dati sono sempre protetti con Coin Sin Limited. Completando questo modulo, accetti di ricevere le nostre email di marketing.", // Modified
  ...
  it: {
    ...
    testimonialsTitle2: "",
    tradingEasyTitle: "",
    tradingEasyHighlight: "",
    tradingEasyIntro: "",
    featureAiSelectionsTitle: "",
    featureAiSelectionsText: "",
    featureAutoTradingTitle: "",
    ...
    smallFormNamePlaceholder: "",
    smallFormSurnamePlaceholder: "",
    smallFormEmailPlaceholder: "",
    smallFormPhonePlaceholder: "",
    smallFormDobPlaceholder: "",
    smallFormRegisterButton: "",
    smallFormTermsText: "",
...
const testimonials = [
  ...
  },
  {
    ...
    text: {
      ...
      ca: "Després d'anys de feina dura, buscava una forma d'assegurar la meva jubilació. L'automatització i la precisió de la IA em permeten generar guanys sense estrès. És la millor decisió financera que he pres.",
  ...
  },
  {
    ...
    text: {
      ...
      ca: "Gràcies a Coin Sin Limited, vaig poder pagar els meus deutes i començar a estalviar per a la meva casa. La facilitat d'ús i el suport al client són excepcionals. Em sento segura invirtiendo aquí, sabiendo que la IA està treballant per a mi 24/7.",
  ...
  },
  {
    ...
    text: {
      ...
      it: "Non avrei mai pensato che alla mia età avrei potuto capire el mundo delle criptovalute, ma Coin Sin Limited lo ha reso possibile. La piattaforma è intuitiva e i risultati sono costanti. È una benedizione per la mia economia familiare!",
    },
  },
]
const faqData = [
  {
    ...
    question: {
      ...
      it: "Cosa posso aspettarmi in termini de risultati?",
    },
    answer: {
...
const countryCodes = [
  ...
  { id: "PA", code: "+507", flag: "🇵🇦", country: "Panamá", name: "Panamá" },
...
export default function CryptoLanding() {
  ...
  const [registrationState, registrationAction] = useFormState<FormState, FormData>(submitRegistration, {
    ...
    errors: {
      ...
      language: undefined,
      _form: undefined, // Asegúrate de que _form esté definido aquí
    },
  })
  ...
  const potentialProfitAmount = calculateReturn(calculatorData.investment, calculatorData.days)
  // const percentageGain = calculatePercentage(calculatorData.investment, calculatorData.days) // Removed as per user request
    ...
    <div className="min-h-screen relative overflow-hidden bg-blue-950">
      ...
      <div className="relative z-10" aria-label="Background image of cryptocurrency charts">
        ...
        <div className="relative z-20 min-h-screen flex flex-col">
          ...
          <header className="relative z-20 grid grid-cols-[auto_1fr_auto] items-center py-1 px-2 sm:py-2 sm:px-4">
            ...
            <div className="flex items-center gap-2">
              <img
                ...
                className="h-32 w-64 sm:h-40 sm:w-80 object-contain rounded-lg" // Increased logo size
              />
            </div>
            {/* Dynamic Counters Column (now a separate component) */}
            <DynamicCounters language={language} translations={translations} />
          ...
          {/* Main Content (Hero section, Video, Form) - Adjusted for higher visibility */}
          <div className="container mx-auto px-4 py-4 sm:px-6 sm:py-4 flex-grow flex items-center justify-center">
            {" "}
            {/* Changed items-start to items-center and added justify-center */}
            <div className="w-full max-w-6xl">
              {" "}
              {/* Changed max-w-7xl to max-w-6xl for smaller interface */}
              {/* Moved "READY TO JOIN" banner here */}
              <div className="bg-blue-700/50 text-white p-3 rounded-lg flex items-center gap-2 mb-4 animate-in slide-in-from-left-5 duration-700">
                <Info className="w-4 h-4" />
                <span className="font-semibold text-sm">{t.readyToJoin}</span>
              </div>
              <div className="rounded-2xl p-4 sm:p-6 shadow-2xl border border-blue-400/20 animate-in slide-in-from-bottom-5 duration-700 glowing-form-shadow">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 items-start">
                      ...
                      <div className="relative bg-transparent rounded-xl overflow-hidden glowing-form-shadow">
                        <div className="relative w-full" style={{ paddingTop: "56.25%", overflow: "hidden" }}>
                          ...
                          <iframe
                            ...
                            src="https://www.youtube.com/embed/I_vf6Crunxw?autoplay=1&mute=1&controls=1&modestbranding=1&rel=0&loop=1&playlist=I_vf6Crunxw&playsinline=1&vq=hd1080" // Added mute=1 and controls=1 for user control
                  ...
                  <div id="registration-form" className="space-y-4">
                    ...
                    {/* Acceso seguro a _form */}
                    {registrationState.errors?._form && registrationState.errors._form.length > 0 && (
                        ...
                        <form className="space-y-3" action={registrationAction}>
                                  ...
                                  <SelectValue>
                                    <div className="flex items-center gap-1">
                                      <span className="text-xs font-semibold">
                                        {selectedCountry?.id.toUpperCase()} {selectedCountry?.code || t.searchCountry}
                                      </span>
                                    </div>
                                  </SelectValue>
                                </SelectTrigger>
                          ...
                          <div className="text-xs text-white/80 leading-relaxed animate-in fade-in-50 duration-500 delay-700 bg-white/5 p-3 rounded-lg border border-white/10">
                            <div className="flex items-start gap-1">
                              ...
                              <span>
                                {t.privacyText}{" "}
                                <Link href="/terms" className="underline text-orange-300 hover:text-orange-400">
                                  {t.footerTerminos}
                                </Link>
                              </span>
                            </div>
              ...
              {/* Text that was moved - now below the video/form container */}
              <div className="text-center mt-8 sm:mt-10">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-1 sm:mb-2 leading-tight">
                  {t.mainTitle}
                  <br />
                  <span className="text-orange-400">{t.mainTitleHighlight}</span>
                </h1>
                <p className="text-xs sm:text-sm text-gray-300 mb-2 sm:mb-4">{t.subtitle}</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="relative">
                        <input
                          type="range"
                          min="250" // Minimum investment
                          max="100000" // Maximum investment
                          step="10" // Step for continuous sliding
                          value={calculatorData.investment} // Use actual value
                        ...
                        <div className="flex justify-between text-white text-xs sm:text-sm mt-2 px-1">
                          {investmentValues.map((val, idx) => (
                            <span key={idx}>{val >= 1000 ? `${val / 1000}k` : val}</span>
                          ))}
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="mt-6 sm:mt-8 text-center">
                    <div className="bg-white/10 p-4 sm:p-6 rounded-xl mb-6">
                      <p className="text-white text-lg sm:text-xl font-semibold mb-2">{t.potentialProfit}</p>
                      <p className="text-4xl sm:text-5xl font-bold text-green-400">
                        {potentialProfitAmount.toLocaleString()} €
                      </p>
                      {/* Removed the percentage gain display as per user request */}
                    </div>
                    <Button
                      onClick={() => {
                                ...
                                <SelectContent className="w-[var(--radix-popper-anchor-width)] max-h-80 rounded-xl border-0 shadow-2xl bg-white/95 backdrop-blur-sm">
                                  {filteredCountries.map((country) => (
                                    <SelectItem key={country.id} value={country.code}>
                                      {country.flag} {country.code} {language === "es" ? country.name : country.country}
                                    </SelectItem>
                                  ))}
                                  {filteredCountries.length === 0 && (
